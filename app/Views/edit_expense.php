...
<head>
  ...
  <style>
    :root{
      /* ✅ White + Red Theme (matched with your analytics page) */
      --bg:#f7f7fb;
      --panel:#ffffff;
      --panel2:#fafafa;
      ...
      <div class="surface">
        <div class="surface-header">
          <div class="d-flex align-items-end justify-content-between flex-wrap gap-2 pb-3">
            <div>
              <h2 class="h-title mb-1">Edit Expense</h2>
              <div class="h-sub">Update your spending record.</div>
            </div>
        ...
        <div class="p-3 p-md-4">
          ...
          <?php
            // expects: $expense = ['id'=>..., 'expense_date'=>..., 'category'=>..., 'description'=>..., 'amount'=>...]
            $selectedCategory = $expense['category'] ?? '';
            $categoryOptions = [
              'Food','Transportation','Bills','Entertainment','Healthcare',
              'Shopping','Education','Savings','Other'
            ];
          ?>

          <form action="<?= base_url('/expenses/update/' . ($expense['id'] ?? 0)) ?>" method="post">
            <?= csrf_field() ?>
            ...
            <div class="row g-3">
              ...
              <div class="col-12 d-flex gap-2 justify-content-end mt-2">
                <a href="<?= base_url('/expenses') ?>" class="btn btn-ghost">Cancel</a>
